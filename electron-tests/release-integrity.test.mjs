...
async function fixture(signature) {
  const directory = await mkdtemp(path.join(os.tmpdir(), "deepsonder-electron-release-integrity-"));
  const installer = "DeepSonder-Electron-v0.1.0-beta-windows-x64-setup.exe";
  const portable = "DeepSonder-Electron-v0.1.0-beta-windows-x64.zip";
